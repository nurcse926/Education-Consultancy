        ...
        public function render () {
            ...
            if ( isset ( $this->value ) && is_array ( $this->value ) && !empty ( $this->value ) ) {
                ...
                echo '<li><input type="' . $title_type . '" id="' . $this->field['id'] . '-subtitle_' . $x . '" name="' . $this->field['name'] . '[' . $x . '][subtitle]' . $this->field['name_suffix'] . '" value="' . esc_attr ( $slide[ 'subtitle' ] ) . '" placeholder="' . $placeholder . '" class="full-text slide-title" /></li>';
                    ...
                    $placeholder = ( isset ( $this->field[ 'placeholder' ][ 'url-1' ] ) ) ? esc_attr ( $this->field[ 'placeholder' ][ 'url-1' ] ) : __ ( 'URL', 'redux-framework' );
                    ...
                    echo '<li><input type="' . $url_type . '" id="' . $this->field[ 'id' ] . '-url-1_' . $x . '" name="' . $this->field[ 'name' ] . '[' . $x . '][url-1]' . $this->field['name_suffix'] .'" value="' . esc_attr ( $slide[ 'url-1' ] ) . '" class="full-text" placeholder="' . $placeholder . '" /></li>';
            ...
            if ( $x == 0 ) {
                ...
                $placeholder = ( isset ( $this->field[ 'placeholder' ][ 'subtitle' ] ) ) ? esc_attr ( $this->field[ 'placeholder' ][ 'subtitle' ] ) : __ ( 'Subtitle', 'redux-framework' );
                echo '<li><input type="' . $title_type . '" id="' . $this->field['id'] . '-subtitle_' . $x . '" name="' . $this->field['name'] . '[' . $x . '][subtitle]' . $this->field['name_suffix'] . '" value="' . esc_attr ( $slide[ 'title' ] ) . '" placeholder="' . $placeholder . '" class="full-text slide-title" /></li>';
