...
<div class="container">
    ...
    <div class="row" style="height:1200px; width: 100%;  margin-top: 150px">
        <div class="col-md-8">
            <div class="st">
            
        <h3 style="font-family: Times New Roman; font-size: 30px">Full Bank Support</h3>
